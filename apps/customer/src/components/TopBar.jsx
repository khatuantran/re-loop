...
import { IconChevronRight, IconSearch, IconBell } from '@reloop/ui';
...
export default function TopBar({ onMenuClick }) {
  ...
  const label = current?.label ?? 'RE-LOOP';
    ...
    <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
      <div className="px-4 md:px-8 h-14 flex items-center gap-3 md:gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          />
          <input
            placeholder="Tìm collector, lô, đơn..."
            className="h-9 pl-9 pr-3 text-[12.5px] rounded-lg border border-slate-200 bg-slate-50 outline-none w-72 focus:border-emerald-300 focus:bg-white"
          />
        </div>
